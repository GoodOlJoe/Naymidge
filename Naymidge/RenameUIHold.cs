...
namespace Naymidge
{
    // this was a work-in-progress using three flyleaf Hosts -- one for the main media being rpeviewed
    // and one each for the previous and next media files. Not sure I will need it but it works (in
    // its mockup-stage and didn't want to discard it)
    public partial class RenameUIHold : Form
    {
        ...
        public RenameUIHold(ProcessingScope scope)
        {
            _Scope = scope;
            CurrentItem = 0;
